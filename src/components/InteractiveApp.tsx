...
export default function InteractiveApp() {
  ...
  return (
    <section id="alpha-gym" className="relative py-20 sm:py-28 bg-[#050d1a] text-white overflow-hidden border-t-2 border-b-2 border-[#1e3a8a] giga-blue-grid selection:bg-[#00ff88] selection:text-[#050d1a]">
      
      {/* Background ambient glows */}
      <div className="absolute inset-0 pointer-events-none select-none z-0">
        <div className="absolute top-[20%] left-[10%] w-80 h-80 rounded-full bg-[#00ff88]/10 blur-[150px]"></div>
        <div className="absolute bottom-[20%] right-[10%] w-80 h-80 rounded-full bg-[#0052FF]/20 blur-[150px]"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <p className="font-sans text-base sm:text-lg text-white/90 font-medium max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-6xl mx-auto items-stretch">
          ...
          <div className="lg:col-span-6 giga-card p-6 sm:p-8 rounded-2xl border-2 border-[#00ff88] shadow-xl flex flex-col justify-between relative overflow-hidden text-white">
            
            <div className="space-y-6">
              <div className="flex justify-between items-center border-b border-[#1e3a8a] pb-3">
                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded bg-[#0c2244] text-[#00ff88] text-xs font-mono font-bold border border-[#00ff88]/50">
              ...
              <div className="text-center space-y-2">
                <h3 className="font-display text-sm sm:text-base font-bold text-white/80 uppercase">
                ...
                <div className="inline-block px-4 py-1.5 rounded-full bg-[#0a2040] border border-[#00ff88]/60 shadow-sm">
              ...
              {/* Clicker Area */}
              <div className="relative h-64 bg-[#07152b] rounded-xl border-2 border-dashed border-[#00ff88]/50 flex items-center justify-center group overflow-hidden">
                ...
                <AnimatePresence>
                  {floatingVibes.map((item) => (
                    <motion.div
                      ...
                      className="absolute pointer-events-none z-30 font-display font-black text-[#00ff88] drop-shadow-[0_2px_10px_rgba(0,0,0,0.9)] whitespace-nowrap"
                ...
                <button
                  ...
                  className="relative z-20 w-44 h-44 rounded-full bg-gradient-to-tr from-[#091a32] via-[#0c2244] to-[#00ff88] border-4 border-[#00ff88] shadow-[0_0_40px_rgba(0,255,136,0.5)] flex flex-col items-center justify-center p-3 text-center cursor-pointer hover:scale-105 active:scale-95 transition-transform group"
                  aria-label="Tap to pump iron with Giga Toad Pepe"
                >
                  <div className="w-24 h-24 rounded-full overflow-hidden border-2 border-white/80 mb-1 shadow-md">
                    <img
                      src={GIGATOAD_LOGO}
                      alt="Giga Toad Pepe"
                  ...
                  <span className="text-[11px] font-mono font-black text-[#050d1a] bg-[#00ff88] px-2.5 py-0.5 rounded-full uppercase tracking-wider shadow-sm">
                    PUMP THE IRON
                  </span>
                </button>
              </div>
            ...
            <div className="mt-6 pt-4 border-t border-[#1e3a8a] flex items-center justify-between text-xs font-mono text-white/70">
              ...
              <button
                ...
                className="hover:text-[#00ff88] flex items-center gap-1 underline cursor-pointer bg-transparent border-none text-white/70"
              >
          ...
          <div className="lg:col-span-6 giga-card p-6 sm:p-8 rounded-2xl border-2 border-[#00ff88] shadow-xl flex flex-col justify-between text-white">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-mono font-black text-lg text-[#00ff88] bg-[#0a2040] px-3 py-1 rounded-lg border border-[#1e3a8a]">
                    {solInvestment} SOL
                  </span>
                </div>
                ...
                <input
                  ...
                  className="w-full h-3 bg-[#0a2040] rounded-lg appearance-none cursor-pointer accent-[#00ff88]"
                />
              ...
              <div className="grid grid-cols-2 gap-3 pt-2">
                <div className="p-4 rounded-xl bg-[#07152b] border border-[#1e3a8a]">
            ...
            <div className="mt-6 pt-4 border-t border-[#1e3a8a]">
              <div className="p-3 rounded-xl bg-[#0a2040] border border-[#1e3a8a] text-center">
