      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10">
        ...
        <div className="max-w-3xl mx-auto bg-zinc-900/80 border border-white/10 p-6 rounded-3xl shadow-2xl backdrop-blur-md text-center space-y-6">
          <div className="space-y-1">
            ...
            <p className="text-xs text-zinc-400 max-w-xl mx-auto font-sans font-medium">
              Verify this address on Jupiter or Raydium. Beware of copycats and scammers! Only use this exact address.
            </p>
          </div>

          <div className="bg-black/50 px-4 py-3 rounded-2xl border border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4 max-w-xl mx-auto">
            <span className="font-mono text-xs font-bold text-zinc-300 select-all overflow-hidden text-ellipsis whitespace-nowrap w-full sm:w-auto">
              {contractAddress}
            </span>
            <button
              onClick={handleCopy}
